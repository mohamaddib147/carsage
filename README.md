...
6. **Choose your currency.** The **USD | LBP** switch in the header (shown when you are logged in) picks which currency every price shows first, in bold, with the other in parentheses. It applies everywhere at once (the Trip Planner's pump price, fuel and tank costs, and the Fuel Log) and your choice is remembered in this browser. Prices are converted at a fixed rate of 1 USD = 89,700 LBP.
