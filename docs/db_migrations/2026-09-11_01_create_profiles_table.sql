-- Exported from the live Supabase project's migration history (version 20260911081655,
-- name create_profiles_table) so the database can be recreated from this repo.
